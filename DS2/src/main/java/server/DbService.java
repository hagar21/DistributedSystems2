...
public class DbService extends UberServiceGrpc.UberServiceImplBase {

    // private final UberClient client;

    public DbService() {
        System.out.println("DB server is up!\n -------------");
    }

    // city server
    @Override
    public void insertRideToDb(Ride request, StreamObserver<Result> responseObserver) {
        // this.client.insertRideToDb(request);
        System.out.println("DB server got insertRideToDb request!");
        System.out.println("-------------");
